...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-xs-12 mb-4">
        <div class="card border-left-warning shadow h-100 py-2 rounded-0 border-4">
            <div class="card-body py-1">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-lg font-weight-bold mb-1">Leave Requests</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800 text-right"><?= $leave_count ?></div>
                    </div>
                    <div class="col-auto">
                        <i class="fa-solid fa-bell fa-2x text-gray-300"></i>
                    </div>
                </div>
            </div>
        </div>
